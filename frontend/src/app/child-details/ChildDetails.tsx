...
const Form: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const storeResponse = await fetch("https://arm-fired-consumers-gross.trycloudflare.com/store-user-details", {
        method: "POST",
        body: formData,
      });
      if (!storeResponse.ok) {
      ...
      const workflowResponse = await fetch("https://arm-fired-consumers-gross.trycloudflare.com/execute-workflow", {
        method: "POST",
