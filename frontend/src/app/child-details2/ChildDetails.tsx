...
import { bookDetails, CardsLP3 } from "@/data/data";
...
const Form: React.FC = () => {
    ...
    const bookPrice = CardsLP3.find((book) => book.bookKey === bookId)?.price || "₹1,999";
                ...
                <>
                    ...
                    `;
                        ...
                        <div className="w-full lg:w-[50%]">
                            ...
                            >
                                ...
                                <p className="text-left text-gray-700 text-lg font-poppins">
                                    Price: <span className="font-semibold">{bookPrice}</span>
                                </p>
                    ...
                    <div className="w-full max-w-5xl mx-auto px-4 py-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {CardsLP3.filter(book => book.bookKey !== bookId).map((book, index) => (
                                <div
                                    key={index}
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Link
                                            href={`/child-details2?book_id=${book.bookKey}&job_type=story`}
