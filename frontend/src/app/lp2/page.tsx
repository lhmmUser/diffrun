        ...
        <main className="w-full min-h-screen relative overflow-hidden space-y-12 px-0 md:px-16 lg:px-40 xl:px-60">
            ...
            <div className="hidden md:flex w-full h-[400px]">
                <div className="w-1/2 bg-[#f7f6cf] flex items-center justify-start px-8">
                    <div className="max-w-sm space-y-6 text-left px-6 md:px-12">
                        <h2 className="text-xl md:text-xl lg:text-2xl xl:text-3xl font-libre font-medium text-gray-900 leading-tight">
                            Turn photos into
                            <br />
                            storybooks, instantly!
                        </h2>
                        <p className="text-sm md:text-base lg:text-lg text-gray-800 font-poppins leading-tight">
            ...
            <div className="block md:hidden w-full">
                ...
                <div className="bg-[#f7f6d0] w-full flex flex-col items-center text-center py-6 px-4">
                    ...
                    <div className="w-full flex flex-col justify-center my-2 space-y-4">
                        <Link href="/books" aria-label="Go to Books page">
                            <div className="relative inline-block">
                                <button className="flex items-center gap-2 bg-[#5784ba] text-white py-3 px-8 font-medium shadow-md transition-all duration-300 hover:bg-transparent hover:border hover:border-black hover:text-black cursor-pointer mt-2">
                                    Generate instant preview
                                </button>
                                <div className="absolute -top-2 -right-5 bg-orange-500 text-white text-xs font-bold px-4 py-2 rounded-full shadow-lg ">
                                    FREE
                                </div>
                            </div>
                        </Link>
                        <p className="text-base sm:text-lg text-gray-800 font-poppins">
                            takes only 2 minutes
                        </p>
                    </div>
                </div>
