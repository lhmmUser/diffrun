...
const Preview: React.FC = () => {
  ...
  const [urlPaid, setUrlPaid] = useState<boolean>(searchParams.get("paid") === "true");
  const [urlApproved, setUrlApproved] = useState<boolean>(searchParams.get("approved") === "true");
      ...
      <div className="min-h-screen bg-gray-100 p-4 sm:p-8">
        {!showContent ? (
          <div className="max-w-4xl mx-auto text-center px-4 py-10">
            <h1 className="text-2xl sm:text-4xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-[#ff0202] to-[#c838cf]">
          ...
          <>
            <header className="max-w-4xl mx-auto mb-12 text-center">
              <motion.h1
                ...
                className="text-2xl sm:text-4xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-[#ff0202] to-[#c838cf]"
              >
                {approved ? (
