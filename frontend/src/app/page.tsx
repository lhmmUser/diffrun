...
export default function Home() {
    return (
        <main className="w-full min-h-screen relative overflow-hidden space-y-12 px-0 md:px-20 lg:px-40 xl:px-60">
            ...
            <div className="hidden md:flex w-full h-[400px]">
                <div className="w-1/2 bg-[#f7f6cf] flex items-center justify-start px-8">
                    <div className="max-w-sm space-y-6 text-left px-6 md:px-12">
                        ...
                        <Link href="/books" aria-label="Go to Books page">
                            <button
                                className="flex items-center gap-2 bg-[#1a5fb4] text-white py-3 px-8 font-medium shadow-md transition-all duration-300 hover:bg-transparent hover:border hover:border-black hover:text-black"
                            >
                ...
                <div className="w-1/2 h-full">
                    <img
                        src="/banner-gif.avif"
                        alt="personalized storybooks banner"
                        width="600"
                        height="400"
                            ...
                            <div className="flex flex-col flex-1 mt-2 space-y-4">
                                ...
                                <div className="mt-auto">
                                    <Link href={`/child-details?job_type=story&book_id=${card.bookKey}`} className="block" aria-label={`Personalize ${card.title} story for ages ${card.age}`}>
                                        <button className="w-full bg-[#1a5fb4] text-gray-100 py-2.5 px-5 font-medium shadow-sm font-play transition-all duration-300 hover:bg-[hsl(213,55%,30%)] hover:text-white focus:outline-none cursor-pointer" aria-label={`Personalize the ${card.title} book`}>
                                            Personalize
                                        </button>
                                    </Link>
                                </div>
