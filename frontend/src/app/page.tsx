...
export default function Home() {
  ...
  <div className="absolute top-0 w-full flex flex-col items-center text-center mt-4 lg:mt-20 px-6">
    <h1 className="w-full text-2xl font-serif sm:text-4xl md:text-5xl font-bold text-white drop-shadow-md">
      Turn photos into storybooks
    </h1>
    <p className="mt-2 text-lg sm:text-2xl text-white max-w-3xl drop-shadow-md">
